...
label_list = ["door symbol", "window symbol", "zone"]
...
label_list = ["jellyfish", "penguin", "shark", "starfish", "stingray"]
...
label_list = ["bird", "drone"]


label_list = ["bird", "drone"]


label_list = ["aortic enlargement", "cardiomegaly", "pleural thickening", "pneumothorax"]


label_list = ["scoliosis spine", "normal spine"]


label_list = ["scoliosis spine", "normal spine"]


label_list = ["vertebra", "scoliosis spine", "normal spine"]
