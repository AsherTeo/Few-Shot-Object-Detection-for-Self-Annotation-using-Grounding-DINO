...
#######################################################################################
            ...
            # x_instances = [obj for obj in instances if self.label_map[str(obj["label"])] == CLASS_X]
            # non_x_instances = [obj for obj in instances if self.label_map[str(obj["label"])] != CLASS_X]

            # if len(x_instances) > MAX_Y:
            #     x_instances = random.sample(x_instances, MAX_Y)

            # # instances = x_instances + non_x_instances
            # print(instances)
#######################################################################################
